        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <div class="sidebar-footer">
                <div class="sidebar-user">
                    ...
                    <a href="/parking_ticketing_system_v2/parking_ticketing_sys/controllers/AuthController.php?action=logout" class="sidebar-logout-btn" title="Logout">
                        ...
                        <div class="table-responsive">
                            <table class="admin-table" id="areasTable">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="3" class="text-center" style="padding:2rem;color:var(--text-muted);">No areas found. Add one to get started.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
